...
plt.plot(freq_q_1417s_unsmooth_half, q_ref_noise_unsmooth_reshape_1417s_array_FFT_half_modified_abs,label='np.fft.fft')
plt.magnitude_spectrum(q_ref_noise_unsmooth_reshape_1417s_array, Fs=1/0.001, color='C3',label='plt.magnitude_spectrum')
...
plt.subplot(2,1,1)
plt.stem(delta_q_ref_noise_unsmooth_reshape, basefmt='None', markerfmt='',linefmt='-C1',label = 'IHDP')
plt.stem(delta_q_ref_noise_smooth_reshape, basefmt='None', markerfmt='',linefmt='-C0',label = 'TS-IHDP')
...
plt.ylabel(r'$\vert \Delta q_{\mathrm{ref}} \vert$ [deg/s]',fontdict={'size':18})
...
plt.stem(delta_action_smooth, basefmt='None', markerfmt='',linefmt='-C0',label='Temporally smoothed')
plt.grid(True)
#plt.title('Lower-level agent',fontdict={'size':20})
plt.xlabel('Time [s]',fontdict={'size':18})
plt.ylabel(r'$\vert \Delta \delta \vert$ [deg]',fontdict={'size':18})
plt.xticks([0, 10000, 20000, 30000, 40000], ['0', '10', '20', '30', '40'],fontsize = 18)
plt.yticks(fontsize = 18)
...
plt.subplot(4,2,1)
plt.plot(q_ref_noise_unsmooth_reshape_1417s,linewidth=1.0,color = 'C1',linestyle='--',label=r'$q_{\mathrm{ref}}$')
plt.plot(q_unsmooth_reshape_1417s,linewidth=1.0,color = 'C0')
plt.grid(True)
plt.xlabel('Time [s]',fontsize=12)
plt.ylabel(r'$q$ [deg/s]',fontsize=12)
plt.title('IHDP',fontsize=12)
plt.xticks([0, 1500, 3000], ['14', '15.5', '17'],fontsize=12)
plt.yticks(fontsize=12)
#plt.legend(loc='upper right',fontsize=16)


plt.subplot(4,2,2)
plt.plot(q_ref_noise_smooth_reshape_1417s,linewidth=1.0,color = 'C1',linestyle='--',label=r'$q_{\mathrm{ref}}$')
#plt.plot(q_ref_smooth_reshape_1417s,linewidth=1.0,color = 'C2',linestyle='--')
plt.plot(q_smooth_reshape_1417s,linewidth=1.0,color = 'C0')
plt.grid(True)
plt.xlabel('Time [s]',fontsize=12)
plt.title('TS-IHDP',fontsize=12)
plt.xticks([0, 1500, 3000], ['14', '15.5', '17'],fontsize=12)
plt.yticks(fontsize=12)
...
plt.grid(True)
#plt.title('Baseline')
plt.xticks([0, 2000, 4000], ['19', '21', '23'],fontsize=12)
plt.ylabel(r'$q$ [deg/s]',fontsize=12)
plt.xticks(fontsize=12)
plt.yticks(fontsize=12)
...
plt.tight_layout()
plt.savefig('Smooth_comparison_q_fft_part_1.pdf',bbox_inches='tight', pad_inches=0.0, dpi=300)
plt.savefig('Smooth_comparison_q_fft_part_1.eps',bbox_inches='tight', pad_inches=0.0, dpi=300)
...
plt.subplot(4,2,2)
plt.plot(q_ref_noise_smooth_reshape_2428s,linewidth=1.0,color = 'C1',linestyle='--',label=r'$q_{\mathrm{ref}}$')
#plt.plot(q_ref_smooth_reshape_2428s,linewidth=1.0,color = 'C2',linestyle='--')
plt.plot(q_smooth_reshape_2428s,linewidth=1.0,color = 'C0')
plt.xlabel('Time [s]',fontsize=16)
plt.grid(True)
...
plt.tight_layout()
plt.savefig('Smooth_comparison_q_fft_part_2.pdf',bbox_inches='tight', pad_inches=0.0, dpi=300)
plt.savefig('Smooth_comparison_q_fft_part_2.eps',bbox_inches='tight', pad_inches=0.0, dpi=300)


#delta frequency comparison (np.fft.fft) size=(4,2)
...
plt.tight_layout()
plt.savefig('Smooth_comparison_action_fft_part_1.pdf',bbox_inches='tight', pad_inches=0.0, dpi=300)
plt.savefig('Smooth_comparison_action_fft_part_1.eps',bbox_inches='tight', pad_inches=0.0, dpi=300)
...
plt.tight_layout()
plt.savefig('Smooth_comparison_action_fft_part_2.pdf',bbox_inches='tight', pad_inches=0.0, dpi=300)
plt.savefig('Smooth_comparison_action_fft_part_2.eps',bbox_inches='tight', pad_inches=0.0, dpi=300)
